      ...
      <div className="flex flex-col-reverse md:flex-row py-20 gap-10 md:gap-20 items-center px-4 md:px-8 lg:px-16">
        ...
        <div className="py-10 md:py-20 text-center md:text-left">
          <h1 className="text-3xl md:text-5xl uppercase font-semibold italic">
            ...
            <br />
            what the <span className="text-[#FF1E00] font-bold">mind</span>{" "}
            believes.
          </h1>
          <p className="text-base md:text-md font-normal pt-2 tracking-tight leading-6">
            Having a perfect body requires a lot of training. Nice-looking body
            and powerful organism are
