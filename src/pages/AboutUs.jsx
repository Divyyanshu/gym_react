    ...
    <div className="mx-10 mt-10 mb-5">
      <div className=" flex flex-col md:flex-row items-center">
        ...
        <div className="mt-10 md:mt-0 md:mx-28 text-center md:text-left">
          <p className="text-2xl md:text-3xl font-light text-[#7F7F7F]">
            About Us
          </p>
          <p className="text-3xl md:text-5xl uppercase font-semibold pb-5">
            ...
            <br />
            little things{" "}
            <span className="text-[#FF1E00] font-bold">matter</span>
          </p>
          <p className="text-lg md:text-xl font-normal pb-5">
            Welcome to DR Fine, your number one source for your good health.
            We're dedicated to providing you the very best of your fitness, with
            an emphasis on extremely trained coaches, up-to-the-mark
            infrastructure, personal focus on each client.
          </p>
          <p className="text-lg md:text-xl font-normal">
            Founded in 2002 by Divyanshu Tailor, DR Fitness has come a long way
            from its beginnings in Bhilwara, Rajasthan. When Divyanshu Tailor
            first started out, his passion for fitness and health drove them to
